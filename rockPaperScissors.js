...
function getComputerChoice() {
    ...
    const randomNumber = Math.floor(Math.random() * 3);
        ...
        if (randomNumber == "rock") {
            compHand.src = "assets/comp_rock.png";
        }
        else if (randomNumber == "paper") {
            compHand.src = "assets/comp_paper.png";
        }
        else if (randomNumber == "scissors") {
            compHand.src = "assets/comp_scissors.png";
        }
...
function main() {
    ...
    rock.addEventListener("click", function() {
        game("rock");
        userHand.src = "assets/user_rock.png";

    })
    
    paper.addEventListener("click", function() {
        game("paper");
        userHand.src = "assets/user_paper.png";

    })
    
    scissors.addEventListener("click", function() {
        game("scissors");
        userHand.src = "assets/user_scissors.png";
        getComputerChoice();
    })
}
